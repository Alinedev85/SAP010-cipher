...
function decifrar() {
  ...
  const mensagem = document.getElementById("mensagem").value; /* cria uma variavel e atribui o valor fornecido no campo de input*/
  const chave = parseInt(document.getElementById("chave")); /* parseInt- transforma o valor recebido do input (string) em um num. inteiro*/
  const codificado = cipher.decode(mensagem, chave); /*será usada para armazenar msg cifrada*/
  document.getElementById("resultado").value = codificado;
}
